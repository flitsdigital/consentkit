  ...
  return (
    <div className="grid h-dvh grid-cols-[220px_1fr]">
      <aside className="flex flex-col border-r border-line bg-panel p-3">
        ...
        <div className="mt-auto flex items-center gap-2 px-2 text-xs"><Avatar initials={USER.initials} size={24} /><span className="min-w-0 flex-1 truncate">{USER.name}</span><Link href="/login" className="btn btn-ghost h-7 px-2 text-[11px]">Uitloggen</Link></div>
      </aside>
      {children}
    </div>
  );
